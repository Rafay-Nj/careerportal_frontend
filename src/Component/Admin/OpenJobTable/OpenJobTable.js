...
export default function OpenJobTable() {
  ...
  React.useEffect(() => {
    axios
      .post(process.env.REACT_APP_BACKEND_URL + "api/listings/getActiveJobs")
      .then((res) => {
