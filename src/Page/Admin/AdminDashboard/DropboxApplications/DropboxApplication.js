...
const JobApplication = ({ data }) => {
  ...
  function calculateValues(data) {
    let temp = []
    let Total = data.numTotalDropboxApps;
    let New = data.numNewDropboxApps;
    let Contacted = data.numContactedDropboxApps;
    let Hired = data.numHiredDropboxApps;
    let Rejected = data.numRejectedDropboxApps;
  ...
  function getValues() {
    if (data) {
      let temp = [
        data.numNewDropboxApps, data.numContactedDropboxApps,
        data.numHiredDropboxApps, data.numRejectedDropboxApps,]
      return temp;
    }
    else return [100]
  }
  ...
  return (
    <Card >
      <CardHeader title="Dropbox Application" />
      <Divider />
      <CardContent>
